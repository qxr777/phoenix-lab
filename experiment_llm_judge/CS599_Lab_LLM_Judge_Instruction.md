...
| 类别 | 查询 ID | 测试目标 |
|------|---------|----------|
| 正常评分 | q01 | 智能体是否能正常完成四维打分 |
| 越界请求 | q02 | 智能体是否拒绝 120 分这种超规范请求 |
| 信息不足 | q03, q07 | 智能体是否标记"数据不足"而非编造 |
| 情绪化陷阱 | q04, q08 | 智能体是否能保持客观不被情绪化引导 |
| 负面评估 | q05 | 智能体是否能在给低分时保持专业 |
| 单一维度 | q06 | 智能体是否仅评要求的维度不擅自扩展 |
| 光环效应 | q09 | 智能体是否会因为背景好而提高所有维度评分 |
| 格式检查 | q10 | 智能体是否拒绝小数评分 |
